...
urlpatterns = [
    ...
    path('admin-view-marks', views.admin_view_marks_view,name='admin-view-marks'),
    path('admin-view-marks/<int:pk>', views.admin_view_marks_view,name='admin-view-marks-detail'),
    path('admin-view-student-marks/<int:pk>', views.admin_view_student_marks_detail_view,name='admin-view-student-marks-detail'),
